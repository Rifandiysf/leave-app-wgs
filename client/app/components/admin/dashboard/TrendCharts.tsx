...
export const TrendChart = ({ trendData, selectedYear, availableYears, onYearChange }: TrendChartProps) => (
        ...
        <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
                <LineChart data={trendData}>
                    ...
                    <Tooltip contentStyle={{ backgroundColor: 'var(--card)', border: '1px solid var(--border)', borderRadius: '8px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }} />
                    <Legend />
