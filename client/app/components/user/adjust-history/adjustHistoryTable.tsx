        ...
        <div className="overflow-x-auto">
            <table className="w-full text-sm">
                <thead className="border-b-[1.5px] border-border bg-[#f0f4f9] dark:bg-card">
                    <tr> 
                        <th className="p-3 font-semibold text-center hidden md:table-cell">NIK</th>
                        <th className="p-3 font-semibold text-center hidden md:table-cell">Name</th>
                        <th className="p-3 font-semibold text-center">Adjustment</th>
                        <th className="p-3 font-semibold text-center hidden md:table-cell">Balance Year</th>
                    ...
                    {isLoading ? (
                        Array.from({ length: itemsPerPage }).map((_, rowIdx) => (
                            <tr key={rowIdx} className="animate-pulse">
                                <td className="p-4 hidden md:table-cell"><div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-3/4 mx-auto" /></td>
                                <td className="p-4 hidden md:table-cell"><div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-3/4 mx-auto" /></td>
                                <td className="p-4"><div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-3/4 mx-auto" /></td>
                                <td className="p-4 hidden md:table-cell"><div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-3/4 mx-auto" /></td>
                                <td className="p-4"><div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-3/4 mx-auto" /></td>
                                <td className="p-4"><div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-3/4 mx-auto" /></td>
                                <td className="p-4"><div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-3/4 mx-auto" /></td>
                        ...
                        <tr><td colSpan={7} className="p-4 text-center text-gray-500">No adjustment history found.</td></tr>
                    ) : (
                        history.map((log, index) => (
                            <tr key={log.id || `${log.NIK}-${index}`} className="odd:bg-[#e8efff] even:bg-[#f8faff] hover:bg-[#e3e7f0] odd:dark:bg-card/30 even:dark:bg-card/70 transition-colors duration-300">
                                <td className="p-2 text-center border-b-[1.5px] border-[#0000001f] hidden md:table-cell">{log.NIK}</td>
                                <td className="p-2 text-center border-b-[1.5px] border-[#0000001f] hidden md:table-cell">{log.name}</td>
                                <td className="p-2 text-center border-b-[1.5px] border-[#0000001f]">{log.adjustment_value}</td>
                                <td className="p-2 text-center border-b-[1.5px] border-[#0000001f] hidden md:table-cell">{log.balance_year}</td>
                                    ...
                                    <Modal mode='info' size='icon' variant='ghost' title='Adjusment Detail' triggerLabel={<i className="bi bi-info-circle text-xl text-blue-500 hover:text-blue-700"></i>} showFooter={false}>
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                            <div className="flex flex-col gap-5">
                                                ...
                                                <div className="flex flex-col gap-0.5"><Label className="font-bold text-gray-500">Adjusment</Label><h1>{log.adjustment_value} Day(s)</h1></div>
                                            ...
                                            <div className="flex flex-col gap-5">
                                                ...
                                                <div className="flex flex-col gap-0.5"><Label className="font-bold text-gray-500">Actor</Label><h1>{log.notes}</h1></div>
                                            </div>
                                        </div>
                                    </Modal>
                                </td>
