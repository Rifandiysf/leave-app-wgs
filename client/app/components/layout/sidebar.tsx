                    ...
                    <aside className="w-64 flex-col hidden lg:flex bg-white h-full fixed lg:relative z-50">
                        ...
                        <nav className="bg-blue-100 p-4 flex-1 pt-5 relative rounded-se-4xl">
                            <div className=" font-semibold mt-8">
                                <Link href="/" className={`flex items-center py-3 px-6 rounded-full transition-colors ${isActive('/user/dashboard')}`}>
                                ...
                                <Link href="/admin/list-leave" className={`flex items-center py-3 px-6 rounded-full transition-colors ${isActive('/admin/list-leave')}`}>
